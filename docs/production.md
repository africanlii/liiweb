...
dokku config:set countrylii WEB_CONCURRENCY=4
```
...
* Upload [scripts/s3-cdn-user.yaml](https://github.com/africanlii/liiweb/raw/master/scripts/s3-cdn-user.yaml) and click **Next**
