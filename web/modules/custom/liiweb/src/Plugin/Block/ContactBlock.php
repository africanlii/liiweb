...
class ContactBlock extends BlockBase {
  ...
  public function build() {
    ...
    //website email
    $items['website_email'][] = [
      '#markup' => '<a href="https://tcilii.org/" target="_blank" class="icon--website list-inline-item" ><i class="fas fa-globe-africa"></i>tcilii.org</a>',
    ];
    $items['website_email'][] = [
      '#markup' => '<a href="mailto:info@tcilii.org" class="icon--email list-inline-item" ><i class="fas fa-at"></i>info@tcilii.org</a>',
    ];
