...
class ContactBlock extends BlockBase {
  ...
  public function build() {
    ...
    //website email
    $items['website_email'][] = [
      '#markup' => '<a href="https://lesotholii.org/" target="_blank" class="icon--website list-inline-item" ><i class="fas fa-globe-africa"></i>lesotholii.org</a>',
    ];
    $items['website_email'][] = [
      '#markup' => '<a href="mailto:info@lesotholii.org" class="icon--email list-inline-item" ><i class="fas fa-at"></i>info@lesotholii.org</a>',
    ];

    //Social media
    $platforms = [
      'fab fa-facebook-square' => 'https://facebook.com/LesothoLII/',
