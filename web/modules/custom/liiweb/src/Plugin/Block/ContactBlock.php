...
class ContactBlock extends BlockBase {
  ...
  public function build() {
    ...
    //website email
    $items['website_email'][] = [
      '#markup' => '<a href="https://seylii.org/" target="_blank" class="icon--website list-inline-item" ><i class="fas fa-globe-africa"></i>seylii.org</a>',
    ];
    $items['website_email'][] = [
      '#markup' => '<a href="mailto:info@seylii.org" class="icon--email list-inline-item" ><i class="fas fa-at"></i>info@seylii.org</a>',
    ];
