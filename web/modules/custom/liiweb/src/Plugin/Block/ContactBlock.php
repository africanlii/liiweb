...
class ContactBlock extends BlockBase {
  ...
  public function build() {
    ...
    //website email
    $items['website_email'][] = [
      '#markup' => '<a href="https://zambialii.org/" target="_blank" class="icon--website list-inline-item" ><i class="fas fa-globe-africa"></i>zambialii.org</a>',
    ];
    $items['website_email'][] = [
      '#markup' => '<a href="mailto:info@zambialii.org" class="icon--email list-inline-item" ><i class="fas fa-at"></i>info@zambialii.org</a>',
    ];

    //Social media
    $platforms = [
      'fab fa-facebook-square' => 'https://facebook.com/ZambiaLegal',
      'fab fa-twitter-square'    => 'https://twitter.com/ZambiaLII',
    ];
