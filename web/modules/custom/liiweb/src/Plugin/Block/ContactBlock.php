...
class ContactBlock extends BlockBase {
  ...
  public function build() {
    ...
    //website email
    $items['website_email'][] = [
      '#markup' => '<a href="https://za.africanlii.org/" target="_blank" class="icon--website list-inline-item" ><i class="fas fa-globe-africa"></i>za.africanlii.org</a>',
    ];
    $items['website_email'][] = [
      '#markup' => '<a href="mailto:info@za.africanlii.org" class="icon--email list-inline-item" ><i class="fas fa-at"></i>info@za.africanlii.org</a>',
    ];
